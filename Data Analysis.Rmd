...
`countData.csv` file contains all data for the endangered species. For all species, 
...
(i.e., Poisson, Negative Binomial and Zero Inflated). The file `weatherData.csv` 
has information on moon cycle and rainfall.
