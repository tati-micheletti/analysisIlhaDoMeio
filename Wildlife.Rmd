...
Next, we will continue our analysis with the Cucuruta (Noronha Elaenia; **). 

```{r elaeniaRata}
elaeniaMeio <- modelElaenia(DT = Data, island = "Ilha do Meio")
elaeniaRata <- modelElaenia(DT = Data, island = "Ilha Rata")
```
