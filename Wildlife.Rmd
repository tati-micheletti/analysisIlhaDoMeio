...
Binomial Models would have been appropriate, as these model counts, especially if there is variability 
in the underlying rate of events. However, these are better suited for overdispersed data, which ours 
...
#TODO Make only one function for both places. The models explored need to be the same.
